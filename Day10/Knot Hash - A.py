...
def __main__(input_file):
    ...
    for input_line in input_file:
        commands = [int(command) for command in input_line.split(",")]
        process_check_result = knot(commands, knot_list)
        print("##--RESULT--##")
...
if __name__ == "__main__":
    ...
    # Input file
    input_file = open('../Input/Day10-A.txt', 'r')
