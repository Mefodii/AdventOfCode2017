...
# Functions
#######################################################################################################################
def next_good_value(value, factor, criteria):
    nextValue = value
    while True:
        nextValue = next_value(nextValue, factor)
        if nextValue % criteria == 0:
            return nextValue
...
def duel(first_robot_initial_line, second_robot_initial_line):
    ...
    for i in range(5000000):
        robot_a_value = next_good_value(robot_a_value, factor_a, criteria_a)
        robot_b_value = next_good_value(robot_b_value, factor_b, criteria_b)
