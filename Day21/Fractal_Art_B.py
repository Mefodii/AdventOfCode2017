...
def compare_matrix(first_matrix, second_matrix):
    if first_matrix == rotate(second_matrix, 0):
        return True
    elif first_matrix == rotate(second_matrix, 90):
        return True
    elif first_matrix == rotate(second_matrix, 180):
        return True
    elif first_matrix == rotate(second_matrix, 270):
        return True
    elif first_matrix == rotate(flip(second_matrix), 0):
        return True
    elif first_matrix == rotate(flip(second_matrix), 90):
        return True
    elif first_matrix == rotate(flip(second_matrix), 180):
        return True
    elif first_matrix == rotate(flip(second_matrix), 270):
        return True
    else:
        return False
...
def expand_matrix(matrix, rule_list):
    ...
    for m in matrix_split:
        ...
        while run and index < len(rule_list):
            ...
            if compare_matrix(m, pattern_input):
